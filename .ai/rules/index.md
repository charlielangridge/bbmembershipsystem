...
| app/Http/**|app/Models/User.php|config/auth.php|config/fortify.php|config/sanctum.php|routes/**|resources/js/pages/auth/**|tests/Feature/Auth/** | .ai/rules/feature-auth.md |
